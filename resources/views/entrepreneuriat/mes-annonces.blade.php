...
<head>
  ...
  <title>Mes annonces — Plateforme Mboma</title>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
    ...
    .statut-actif { color:var(--vert); }
    .statut-inactif { color:var(--gris); }
...
<div class="page-wrap">
    ...
    <div class="page-header">
      <div>
        <h1>Mes annonces</h1>
        <p>Gérez vos annonces de produits et services</p>
      </div>
      <a href="{{ route('entrepreneuriat.annonce.create') }}" class="btn btn-primary">
        ➕ Nouvelle annonce
      </a>
    </div>
          ...
          <div class="annonce-card">
            ...
            <div class="annonce-footer">
              <div class="annonce-actions">
                <a href="{{ route('entrepreneuriat.annonce.show', $annonce) }}" class="btn btn-sm btn-secondary">
                  Voir
                </a>
    ...
    @else
      <div class="empty-state">
        ...
        <p>Publiez votre première annonce de produit ou service !</p>
        <a href="{{ route('entrepreneuriat.annonce.create') }}" class="btn btn-primary">Créer une annonce</a>
      </div>
    @endif
  </div>
