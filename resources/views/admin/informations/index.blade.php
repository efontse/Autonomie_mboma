...
<head>
  ...
  <title>Informations — Admin Mboma</title>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
    ...
    .badge-actualite { background:#FEF3C7; color:#D97706; }
    .badge-annonce { background:#FEE2E2; color:#DC2626; }
    ...
    @media (max-width:900px) { .page-wrap { margin-left:0; padding:1.5rem; padding-top: 4rem; } .sidebar { transform:translateX(-100%); } .sidebar.ouvert { transform:translateX(0); } .btn-menu-mobile { display: flex !important; } }
    /* Bouton menu mobile */
...
<body>
  ...
  <div class="page-wrap">
    <div class="page-header">
      ...
      <a href="{{ route('admin.informations.create') }}" class="btn btn-primary">+ Nouvelle information</a>
    </div>
    ...
    <div class="table-wrap">
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td><strong>{{ $information->titre }}</strong></td>
            <td><span class="badge badge-{{ $information->type }}">{{ ucfirst($information->type) }}</span></td>
            <td>{{ $information->auteur->prenom ?? '-' }} {{ $information->auteur->nom ?? '-' }}</td>
          ...
          @empty
          <tr>
            <td colspan="5" style="text-align:center; padding:2rem;">Aucune information trouvée</td>
          </tr>
          @endforelse
        </tbody>
      </table>
