...
<head>
  ...
  <title>Détails utilisateur — Admin Mboma</title>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
    ...
    .btn-danger { background:var(--rouge); color:var(--blanc); border:none; }
    ...
    .user-info h2 { font-family:'Cormorant Garamond',serif; font-size:1.75rem; font-weight:700; margin-bottom:0.25rem; }
    .user-info .badge {
    ...
    .info-label { font-size:0.75rem; font-weight:600; text-transform:uppercase; letter-spacing:0.05em; color:var(--gris); margin-bottom:0.25rem; }
    .info-value { font-size:1rem; color:var(--texte); }

    .danger-zone {
      margin-top:2rem; padding:1.5rem;
      background:#FEF2F2; border:1px solid #FECACA; border-radius:8px;
    }
    .danger-zone h3 { color:var(--rouge); font-size:1rem; font-weight:600; margin-bottom:0.5rem; }
    .danger-zone p { font-size:0.85rem; color:var(--texte-doux); margin-bottom:1rem; }
  ...
  <div class="page-wrap">
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <a href="{{ route('admin.utilisateurs.edit', $user) }}" class="btn btn-primary">Éditer</a>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <div class="info-value">{{ $user->quartier ?? '-' }}</div>
        </div>
        <div class="info-item">
          <div class="info-label">Village</div>
          <div class="info-value">{{ $user->village ?? '-' }}</div>
        </div>
        <div class="info-item">
          <div class="info-label">Date de naissance</div>
          <div class="info-value">{{ $user->date_naissance ? $user->date_naissance->format('d/m/Y') : '-' }}</div>
        </div>
        <div class="info-item">
        ...
        <div class="info-item">
          ...
          <div class="info-value">{{ $user->derniere_connexion ? $user->derniere_connexion->format('d/m/Y H:i') : 'Jamais' }}</div>
        </div>
        <div class="info-item">
          <div class="info-label">Statut</div>
          <div class="info-value">{{ $user->statut === 'actif' ? 'Actif' : 'Inactif' }}</div>
        </div>
      </div>
